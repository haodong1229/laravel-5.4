...
<body class='login_body'>
	<div class="wrap">
		...
		<div class="login">
			<div class="email">
				<label for="user">User</label><div class="email-inpu"><div class="control-group"><div class="input-prepend"><span class="add-on"><i class="icon-envelope"></i></span><input type="text" id="username" name="username"  value={{old('username')}}></div><span>{{session('errorr')}}</span></div></div>
			</div>
			<div class="pw">
				<label for="pw">Password</label><div class="pw-inpu"><div class="control-group"><div class="input-prepend"><span class="add-on"><i class="icon-lock"></i></span><input type="password" id="password" name="password" ></div><span>{{session('error')}}</span></div></div>
			</div>
